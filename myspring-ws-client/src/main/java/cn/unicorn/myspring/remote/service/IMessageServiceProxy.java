...
public class IMessageServiceProxy implements cn.unicorn.myspring.remote.service.IMessageService {
  private String _endpoint = null;
  private cn.unicorn.myspring.remote.service.IMessageService iMessageService = null;
  ...
  private void _initIMessageServiceProxy() {
    try {
      iMessageService = (new cn.unicorn.myspring.remote.service.impl.MessageServiceLocator()).getMessageServiceImplPort();
  ...
  public cn.unicorn.myspring.remote.service.IMessageService getIMessageService() {
    if (iMessageService == null)
      _initIMessageServiceProxy();
