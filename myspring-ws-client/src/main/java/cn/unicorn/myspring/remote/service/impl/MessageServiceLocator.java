...
public class MessageServiceLocator extends org.apache.axis.client.Service implements cn.unicorn.myspring.remote.service.impl.MessageService {
    ...
    private java.lang.String MessageServiceImplPort_address = "http://192.168.28.136:7777/message";
    ...
    public cn.unicorn.myspring.remote.service.IMessageService getMessageServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.unicorn.myspring.remote.service.impl.MessageServiceImplPortBindingStub _stub = new cn.unicorn.myspring.remote.service.impl.MessageServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.unicorn.myspring.remote.service.IMessageService.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.unicorn.myspring.remote.service.impl.MessageServiceImplPortBindingStub _stub = new cn.unicorn.myspring.remote.service.impl.MessageServiceImplPortBindingStub(new java.net.URL(MessageServiceImplPort_address), this);
                _stub.setPortName(getMessageServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.remote.myspring.unicorn.cn/", "messageService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.remote.myspring.unicorn.cn/", "MessageServiceImplPort"));
        }
